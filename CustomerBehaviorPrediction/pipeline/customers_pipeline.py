...
def customers_pipeline(train_set: str, retrain: bool):
    ...
    linear_regression_task = linear_regression(preprocess_task.output, retrain)
    xgboost_regressor_task = xgboost_regressor(preprocess_task.output, retrain)
    neural_regression_task = neural_regression(preprocess_task.output, retrain)
