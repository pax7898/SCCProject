...
def customers_pipeline():
    ...
    dataset_list =['dataset1.csv', 'dataset2.csv', 'dataset3.csv']
    # Run load_data task


    # DATASET 1
    load_task = load(dataset_list[0], 'dataset1.csv')
    ...
    # DATASET 2
    load_task = load(dataset_list[1], 'dataset1.csv')
    ...
    # DATASET 1
    load_task = load(dataset_list[2], 'dataset1.csv')
